 ...
 */
public class KafkaDataSimlationClick extends BaseSimlation{
    private static Logger log = LoggerFactory.getLogger(KafkaDataSimlationClick.class);
    ...
    public void process() throws Exception {
        for (int i = 1; i < 10000; i++) {
            ...
            ProducerRecord<String,String> adsProduceRecord = new ProducerRecord<>("test_click", adsContent);
