package com.dtwave.dipper.asset.mllib.linearregression
...
object LinearRegression {
  ...
  def main(args: Array[String]) {
    ...
    //读取样本数据
    val data_path1 = "/Users/hulb/data/mllib/data/lpsa.data"
    ...
    // 模型保存
    val ModelPath = "/Users/hulb/data/mllib/model/LinearRegressionModel"
