package com.dtwave.dipper.asset.mllib.logisticregression
...
object logistic_regression {
  ...
  def main(args: Array[String]) {
    ...
    val data = MLUtils.loadLibSVMFile(sc, "/Users/hulb/data/mllib/data/sample_libsvm_data.txt")
    ...
    //保存模型
    val ModelPath = "/Users/hulb/data/mllib/model/logistic_regression_model"
